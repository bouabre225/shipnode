...
configure_caddy_backend() {
    ...
    local caddy_config
    caddy_config=$(render_caddy_backend_config)
    install_caddy_app_config "$PM2_APP_NAME" "$caddy_config"
...
configure_caddy_frontend() {
    ...
    local caddy_config
    caddy_config=$(render_caddy_frontend_config "$APP_NAME" "$SERVE_PATH")
    install_caddy_app_config "$APP_NAME" "$caddy_config"
